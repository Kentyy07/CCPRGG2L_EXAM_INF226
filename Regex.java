...
public class Regex {
    ...
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^[^dDlLCcRrZz]*(?=[aeiouAEIOU].*\\d$)[^dDlLCcRrZz]*$");
        ...
        pattern = Pattern.compile("^(?=.{10,}|.{15,})([A-Za-z0-9_.]*)[Surname last two digits][A-Za-z0-9_.]*@(gmail.com|ymail.com)$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^(http(s)?://)?([A-Za-z]*[-.]?[A-Za-z]*)+.(com|ph)(/.*)?$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(\\w+\\.(?!java|py|cpp)[\\w]+)");
